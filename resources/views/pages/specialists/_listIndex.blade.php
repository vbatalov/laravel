        ...
        <div class="card-body py-9">
            ...
            <div class="row gx-9 h-100">
                ...
                <div class="col-sm-6 mb-10 mb-sm-0">
                    <!--begin::Image-->
                    <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-400px min-h-sm-100 h-100" style="background-size: 100% 100%;background-image:url('http://127.0.0.1:8000/demo3/media/stock/600x600/img-65.jpg')"></div>
                    <!--end::Image-->
                </div>
                <!--end::Col-->
                <!--begin::Col-->
                    ...
                    <div class="d-flex flex-column h-100">
                        ...
                        <div class="mb-7">
                            ...
                            <div class="d-flex flex-stack mb-6">
                                ...
                                <div class="flex-shrink-0 me-5">
                                    ...
                                    <span class="text-gray-800 fs-1 fw-bold">Ксения А.</span>
                                </div>
                                <!--end::Title-->
                            </div>
                            <!--end::Heading-->
                            ...
                            <div class="d-flex align-items-center flex-wrap d-grid gap-2">
                                ...
                                <div class="d-flex align-items-center me-5 me-xl-13">
                                    ...
                                    <div class="symbol symbol-30px symbol-circle me-3">
                                        <img src="http://127.0.0.1:8000/demo3/media/avatars/300-3.jpg" class="" alt="">
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Info-->
                                    <div class="m-0">
                                        <span class="fw-semibold text-gray-400 d-block fs-8">Компания</span>
                                        <span class="fw-bold text-gray-800 text-hover-primary fs-7">Физическое лицо</span>
                                    </div>
                                    <!--end::Info-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Info-->
                                    <div class="m-0">
                                        <span class="fw-semibold text-gray-400 d-block fs-8">Коммерческий опыт</span>
                                        <span class="fw-bold text-gray-800 fs-7">3 года</span>
                                    </div>
                                    <!--end::Info-->
                                </div>
                                <!--end::Item-->
                        ...
                        <div class="mb-6">
                            ...
                            <span class="fw-semibold text-gray-600 fs-6 mb-8 d-block">
                                Оформление сделок ЕГАИС Лес под ключ. Постоянно обучаюсь на семинарах и участвую в различных мероприятиях связанных с лесом.
                            </span>
                            <!--end::Text-->
                        ...
                        <div class="d-flex flex-stack mt-auto bd-highlight">
                            ...
                            <div class="symbol-group symbol-hover flex-nowrap">
                                <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" aria-label="Melody Macy" data-kt-initialized="1">
                                    <img alt="Pic" src="http://127.0.0.1:8000/demo3/media/avatars/300-2.jpg">
                                </div>
                                <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" aria-label="Michael Eberon" data-kt-initialized="1">
                                    <img alt="Pic" src="http://127.0.0.1:8000/demo3/media/avatars/300-3.jpg">
                                </div>
