    ...
    <div class="card-body pt-9 pb-0">
        ...
        <div class="d-flex flex-wrap flex-sm-nowrap">
            ...
            <div class="me-7 mb-4">
                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                    <img src="https://sp-ao.shortpixel.ai/client/to_webp,q_glossy,ret_img,w_887,h_892/https://xn--c1akgd3ap.xn--p1ai/wp-content/uploads/2022/08/favicon.png" alt="image">
                </div>
            </div>
            <!--end::Pic-->
            <!--begin::Info-->
                    ...
                    <div class="d-flex flex-column flex-grow-1 pe-8">
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <!--end::Number-->
                                <!--begin::Label-->
                                <div class="fw-semibold fs-6 text-gray-400">Критичные проблемы</div>
                                <!--end::Label-->
                            </div>
                            <!--end::Stat-->
                            <!--begin::Stat-->
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <!--end::Number-->
                                <!--begin::Label-->
                                <div class="fw-semibold fs-6 text-gray-400">Обратите внимание</div>
                                <!--end::Label-->
                            </div>
                            <!--end::Stat-->
                            <!--begin::Stat-->
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <!--end::Number-->
                                <!--begin::Label-->
                                <div class="fw-semibold fs-6 text-gray-400">Положительные факты</div>
                                <!--end::Label-->
                            </div>
                            <!--end::Stat-->
                        </div>
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
            ...
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="../../demo10/dist/pages/user-profile/overview.html">Общие данные</a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5" href="../../demo10/dist/pages/user-profile/projects.html">ЕГАИС Лес</a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5" href="../../demo10/dist/pages/user-profile/campaigns.html">Риски</a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5" href="../../demo10/dist/pages/user-profile/documents.html">Документы</a>
            </li>
            <!--end::Nav item-->
        </ul>
        <!--begin::Navs-->
