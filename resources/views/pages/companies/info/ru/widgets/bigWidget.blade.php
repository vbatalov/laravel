    ...
    <div class="col-xl-8">
        ...
        <div class="mb-10">
            ...
            <ul class="nav row mb-10" role="tablist">
                <li class="nav-item col-6 col-lg mb-5 mb-lg-0" role="presentation">
                    <a class="nav-link btn btn-flex btn-color-gray-400 btn-outline btn-active-primary d-flex flex-grow-1 flex-column flex-center py-5 h-1250px h-lg-175px active" data-bs-toggle="tab" href="#kt_general_widget_1_1" aria-selected="true" role="tab">
                        ...
                        <!--end::Svg Icon-->
                        <span class="fs-6 fw-bold">Основные
													<br>Сведения</span>
                    </a>
                </li>
                <li class="nav-item col-6 col-lg mb-5 mb-lg-0" role="presentation">
                    <a class="nav-link btn btn-flex btn-color-gray-400 btn-outline btn-active-primary d-flex flex-grow-1 flex-column flex-center py-5 h-1250px h-lg-175px" data-bs-toggle="tab" href="#kt_general_widget_1_2" aria-selected="false" role="tab" tabindex="-1">
                        ...
                        <!--end::Svg Icon-->
                        <span class="fs-6 fw-bold">Деятельность
													<br>ОКВЭД</span>
                    </a>
                </li>
                <li class="nav-item col-12 col-lg mb-5 mb-lg-0" role="presentation">
                    <a class="nav-link btn btn-flex btn-color-gray-400 btn-outline btn-active-primary d-flex flex-grow-1 flex-column flex-center py-5 h-1250px h-lg-175px" data-bs-toggle="tab" href="#kt_general_widget_1_3" aria-selected="false" role="tab" tabindex="-1">
                        ...
                        <!--end::Svg Icon-->
                        <span class="fs-6 fw-bold">Информация
													<br>о финансах</span>
                    </a>
                </li>
                <li class="nav-item col-12 col-lg mb-5 mb-lg-0" role="presentation">
                    <a class="nav-link btn btn-flex btn-color-gray-400 btn-outline btn-active-primary d-flex flex-grow-1 flex-column flex-center py-5 h-1250px h-lg-175px" data-bs-toggle="tab" href="#kt_general_widget_1_4" aria-selected="false" role="tab" tabindex="-1">
                ...
                <li class="nav-item col-12 col-lg mb-5 mb-lg-0" role="presentation">
                    <a class="nav-link btn btn-flex btn-color-gray-400 btn-outline btn-active-primary d-flex flex-grow-1 flex-column flex-center py-5 h-1250px h-lg-175px" data-bs-toggle="tab" href="#kt_general_widget_1_5" aria-selected="false" role="tab" tabindex="-1">
            ...
            <div class="tab-content">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">Данные на основании выписки из ЕГР</span>
                                <span class="text-muted mt-1 fw-semibold fs-7">Дата выписки: {{ $dateExtract }}</span>
                            </h3>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle gs-5 gy-5 table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="2">
                                                <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">ОПФ</a>
                                                <span class="text-muted fw-semibold d-block fs-7">Организационно-правовая форма</span>
                                            </td>

                                            <td colspan="3">
                                                <span class="text-muted fw-bold text-hover-primary">{{ $fullNameOpf }}</span>
                                            </td>
                                        </tr>

                                        <tr>
                                            <td colspan="2">
                                                <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Наименование</a>
                                                <span class="text-muted fw-semibold d-block fs-7">Полное наименование лица</span>
                                            </td>
                                            <td colspan="3">
                                                <span class="text-muted fw-bold text-hover-primary">{{ $fullname }}</span>
                                            </td>
                                        </tr>

                                        <tr>
                                            <td colspan="2">
                                                <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">ИНН</a>
                                                <span class="text-muted fw-semibold d-block fs-7">Идентификационный номер налогоплательщика</span>
                                            </td>

                                            <td colspan="3">
                                                <span class="text-muted fw-bold text-hover-primary">{{ $inn }}</span>
                                            </td>
                                        </tr>

                                        <tr>
                                            <td colspan="2">
                                                <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">КПП</a>
                                                <span class="text-muted fw-semibold d-block fs-7">Код причины постановки на учет</span>
                                            </td>

                                            <td colspan="3">
                                                <span class="text-muted fw-bold text-hover-primary">{{ $kpp }}</span>
                                            </td>
                                        </tr>

                                        <tr>
                                            <td colspan="2">
                                                <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">ОГРН</a>
                                                <span class="text-muted fw-semibold d-block fs-7 ">Основной государственный регистрационный номер</span>
                                            </td>

                                            <td colspan="3">
                                                <span class="text-muted fw-bold text-hover-primary">{{ $ogrn }}</span>
                                            </td>
                                        </tr>

                                        <tr>
                                            <td colspan="2">
                                                <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Регистрация</a>
                                                <span class="text-muted fw-semibold d-block fs-7">Дата регистрации компании</span>
                                            </td>

                                            <td colspan="3">
                                                <span class="text-muted fw-bold text-hover-primary">{{ $dateOgrn }}</span>
                                            </td>
                                        </tr>

                                        <tr>
                                            <td colspan="2">
                                                <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Юридический адрес</a>
                                                <span class="text-muted fw-semibold d-block fs-7">Официальный адрес юридического лица</span>
                                            </td>

                                            <td colspan="3">
                                                <span class="text-muted fw-bold text-hover-primary">
                                                   {{ $index }}, {{ $region_name }} {{ $region_type }},
                                                    {{ $rayon_name ?? $city_type }}
                                                    {{ $rayon_type ?? $city_name }},
                                                    {{ $street_type }} {{ $street_name }},
                                                    {{ $home_number }} {{ $app_number }}
                                                </span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ $ceo_role_name }}</a>
                                                <span class="text-muted fw-semibold d-block fs-7">{{ $ceo_role_type }}</span>
                                            </td>

                                            <td colspan="3">
                                                <span class="text-muted fw-bold text-hover-primary">
                                                    {{ $ceo_surname }} {{ $ceo_name }} {{ $ceo_patronymic }}
                                                </span>
                                                <span class="text-muted fw-semibold d-block fs-7">
                                                    ИНН: {{ $ceo_inn }}, действует с {{ $ceo_date }}
                                                </span>
                                            </td>
                                        </tr>
                ...
                <div class="tab-pane fade" id="kt_general_widget_1_2" role="tabpanel">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">Виды деятеьности (ОКВЭД)</span>
                                <span class="text-muted mt-1 fw-semibold fs-7">Общероссийский классификатор видов экономической деятельности</span>
                            </h3>
                        </div>
                        <!--end::Header-->
                        <!--begin::Body-->
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle gs-5 gy-5 table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4">
                                            <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ $main_name }}</a>
                                            <span class="text-muted fw-semibold d-block fs-7">{{ $main_code }}</span>
                                        </td>
                                    </tr>
                                    ...
                                    @php
                                        $number = 0;
                                    @endphp
                                    @foreach($okved_dop as $key => $value)
                                        @php
                                            $code = $value['@attributes']['КодОКВЭД'];
                                            $name = $value['@attributes']['НаимОКВЭД'];
                                            $number++;
                                        @endphp
                                        ...
                                        @if($number <= 0)
                                            <tr>
                                                ...
                                                <td colspan="4">
                                                    <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ $name }}</a>
                                                    <span class="text-muted fw-semibold d-block fs-7">{{ $code }}</span>
                                                </td>
                                            </tr>
                                        @else
                                            <tr class="collapse" id="allOkved">
                                                <td>
                                                    <div class="symbol symbol-50px me-5">
                                                    <span class="symbol-label bg-light-success">
                                                        <!--begin::Svg Icon | path: icons/duotune/abstract/abs027.svg-->
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center">
                                            <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#allOkved" aria-expanded="false" aria-controls="allOkved">
                                                <span>Показать все виды деятельности</span>
                                            </button>
                                        </td>
                                    </tr>
                                    @endif
                    ...
                    <div class="card">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar">
                                ...
                                <!--begin::Menu 1-->
                                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_62cfab8e79b4d">
                                    <!--begin::Header-->
                                    <div class="px-7 py-5">
                                    ...
                                    <div class="px-7 py-5">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <!--begin::Input-->
                                            <div>
                                                <select class="form-select form-select-solid select2-hidden-accessible" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_62cfab8e79b4d" data-allow-clear="true" data-select2-id="select2-data-13-7u02" tabindex="-1" aria-hidden="true" data-kt-initialized="1">
                                                    <option data-select2-id="select2-data-15-5rav"></option>
                                                    <option value="1">Approved</option>
                                                    <option value="2">Pending</option>
                                                    <option value="2">In Process</option>
                                                    <option value="2">Rejected</option>
                                                </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-14-y8ne" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-rheq-container" aria-controls="select2-rheq-container"><span class="select2-selection__rendered" id="select2-rheq-container" role="textbox" aria-readonly="true" title="Select option"><span class="select2-selection__placeholder">Select option</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            </div>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
