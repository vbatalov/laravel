...
<div class="menu-active-bg px-4 px-lg-0">
	...
	<div class="tab-content py-4 py-lg-8 px-lg-7">
		...
		<div class="tab-pane active w-lg-1000px" id="kt_app_header_menu_pages_pages">
			{{ theme()->getView('layout/partials/header/_menu/__pages-general') }}
		</div>
		<!--end:Tab pane-->
		<!--begin:Tab pane-->
		<div class="tab-pane w-lg-600px" id="kt_app_header_menu_pages_account">
			{{ theme()->getView('layout/partials/header/_menu/__pages-account') }}
		</div>
		<!--end:Tab pane-->
		<!--begin:Tab pane-->
		<div class="tab-pane w-lg-1000px" id="kt_app_header_menu_pages_authentication">
			{{ theme()->getView('layout/partials/header/_menu/__pages-authentication') }}
		</div>
		<!--end:Tab pane-->
		<!--begin:Tab pane-->
		<div class="tab-pane w-lg-1000px" id="kt_app_header_menu_pages_utilities">
			{{ theme()->getView('layout/partials/header/_menu/__pages-utilities') }}
		</div>
		<!--end:Tab pane-->
		<!--begin:Tab pane-->
		<div class="tab-pane w-lg-500px" id="kt_app_header_menu_pages_widgets">
			{{ theme()->getView('layout/partials/header/_menu/__pages-widgets') }}
		</div>
		<!--end:Tab pane-->
	</div>
	<!--end:Tab content-->
